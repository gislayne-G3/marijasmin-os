...
import { LayoutDashboard, Bot, BarChart3, MessageSquare, Shield, Flower2, LogOut, DollarSign, Activity } from 'lucide-react'
import { supabase } from '../lib/supabase'
import clsx from 'clsx'

const LINKS = [
  { to: '/', label: 'Dashboard', icon: LayoutDashboard, exact: true },
  { to: '/workflows', label: 'Watchdog', icon: Activity },
